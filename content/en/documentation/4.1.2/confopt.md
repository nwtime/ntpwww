...
*   [Configuration Commands](/documentation/4.1.2/confopt/#configuration-commands)
*   [Options](/documentation/4.1.2/confopt/#options)
*   [Auxiliary Commands](/documentation/4.1.2/confopt/#auxiliary-commands)
*   [Bugs](/documentation/4.1.2/confopt/#bugs)
...
: All packets sent to and received from the server or peer are to include authentication fields encrypted using the autokey scheme described in the [Authentication Options](/documentation/4.1.2/authopt/) page. 
...
: Marks the server as preferred. All other things being equal, this host will be chosen for synchronization among a set of correctly operating hosts. See the [Mitigation Rules and the <code>prefer</code> Keyword](/documentation/4.1.2/prefer/) page for further information. 
