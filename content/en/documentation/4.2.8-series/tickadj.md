...
*   [Description](/documentation/4.2.8-series/tickadj/#description)
*   [Command Line Options](/documentation/4.2.8-series/tickadj/#command-line-options)
*   [Files](/documentation/4.2.8-series/tickadj/#files)
*   [Bugs](/documentation/4.2.8-series/tickadj/#bugs)
...
The <code>tickadj</code> program reads, and optionally modifies, several timekeeping-related variables in older kernels that do not have support for precision timekeeping, including HP-UX, SunOS, Ultrix, SGI and probably others. Those machines provide means to patch the kernel <code>/dev/kmem</code>. Newer machines with kernel time support, including Solaris, Tru64, FreeBSD and Linux, should NOT use the program, even if it appears to work, as it will destabilize the kernel time support. Use the [<code>ntptime</code>](/documentation/4.2.8-series/ntptime/) program instead.
