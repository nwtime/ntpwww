...
*  [Introduction](/documentation/3-5.93e/notes/#introduction)
*  [How NTP Works](/documentation/3-5.93e/notes/#how-ntp-works)
*  [Configuring Your Subnet](/documentation/3-5.93e/notes/#configuring-your-subnet)
*  [Configuring Your Server or Client](/documentation/3-5.93e/notes/#configuring-your-server-or-client)
*  [Xntp3 Versus Previous Versions](/documentation/3-5.93e/notes/#xntp3-versus-previous-versions)
*  [Traffic Monitoring](/documentation/3-5.93e/notes/#traffic-monitoring)
*  [Address-and-Mask Restrictions](/documentation/3-5.93e/notes/#address-and-mask-restrictions)
*  [Authentication](/documentation/3-5.93e/notes/#authentication)
*  [Query Programs](/documentation/3-5.93e/notes/#query-programs)
*  [Run-Time Reconfiguration](/documentation/3-5.93e/notes/#run-time-reconfiguration)
*  [Name Resolution](/documentation/3-5.93e/notes/#name-resolution)
*  [Dealing with Frequency Tolerance Violations](/documentation/3-5.93e/notes/#dealing-with-frequency-tolerance-violations)
*  [Tuning Your Subnet](/documentation/3-5.93e/notes/#tuning-your-subnet)
*  [Provisions for Leap Seconds and Accuracy Metrics](/documentation/3-5.93e/notes/#provisions-for-leap-seconds-and-accuracy-metrics)
*  [Clock Support Overview](/documentation/3-5.93e/notes/#clock-support-overview)
*  [Towards the Ultimate Tick](/documentation/3-5.93e/notes/#towards-the-ultimate-tick)
*  [Parting Shots](/documentation/3-5.93e/notes/#parting-shots)
...
Additional information on the interpretation of these data with respect to various radio clock drivers is given in the [Reference Clock Drivers](/documentation/3-5.93e/refclock/) document page and in the individual driver documents accessible via that page.
...
There are three ways to implement PPS support, depending on the radio clock model, platform model and serial line interface. These are described in detail in the application notes mentioned in the [The Network Time Protocol (NTP) Distribution](/documentation/3-5.93e/) document page. Each of these requires circuitry to convert the TTL signal produced by most clocks to the EIA levels used by most serial interfaces. The [Gadget Box PPS Level Converter and CHU Modem](/documentation/3-5.93e/gadget/) page describes a device designed to do this. Besides being useful for this purpose, this device includes an inexpensive modem designed for use with the Canadian CHU time/frequency radio station.
