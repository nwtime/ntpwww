...
*   [Synopsis](/documentation/4.2.4-series/ntpd/#synopsis)
*   [Description](/documentation/4.2.4-series/ntpd/#description)
*   [How NTP Operates](/documentation/4.2.4-series/ntpd/#how-ntp-operates)
*   [Frequency Discipline](/documentation/4.2.4-series/ntpd/#frequency-discipline)
*   [Operating Modes](/documentation/4.2.4-series/ntpd/#operating-modes)
*   [Poll Interval Control](/documentation/4.2.4-series/ntpd/#poll-interval-control)
*   [The huff-n'-puff Filter](/documentation/4.2.4-series/ntpd/#the-huff-n-puff-filter)
*   [Notes](/documentation/4.2.4-series/ntpd/#notes)
*   [Command Line Options](/documentation/4.2.4-series/ntpd/#command-line-options)
*   [The Configuration File](/documentation/4.2.4-series/ntpd/#the-configuration-file)
*   [Configuration Options](/documentation/4.2.4-series/ntpd/#configuration-options)
*   [Files](/documentation/4.2.4-series/ntpd/#files)
...
The filter is activated by the <code>tinker</code> command and <code>huffpuff</code> keyword, as described in the [Miscellaneous Options](/documentation/4.2.4-series/miscopt/) page.
...
Various internal <code>ntpd</code> variables can be displayed and configuration options altered while the <code>ntpd</code> is running using the <code>[ntpq](/documentation/4.2.4-series/ntpq/)</code> and <code>[ntpdc](/documentation/4.2.4-series/ntpdc/)</code> utility programs.
...
[Server Options](/documentation/4.2.4-series/confopt/)  
[Authentication Options](/documentation/4.2.4-series/authopt/)  
[Monitoring Options](/documentation/4.2.4-series/monopt/)  
[Access Control Options](/documentation/4.2.4-series/accopt/)  
[Automatic NTP Configuration Options](/documentation/4.2.4-series/manyopt/)  
[Reference Clock Options](/documentation/4.2.4-series/clockopt/)  
[Miscellaneous Options](/documentation/4.2.4-series/miscopt/)
