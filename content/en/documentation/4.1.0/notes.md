...
*  [Introduction](/documentation/4.1.0/notes/#introduction)
*  [How NTP Works](/documentation/4.1.0/notes/#how-ntp-works)
*  [Configuring Your Subnet](/documentation/4.1.0/notes/#configuring-your-subnet)
*  [Configuring Your Server or Client](/documentation/4.1.0/notes/#configuring-your-server-or-client)
*  [Configuring NTP with NetInfo](/documentation/4.1.0/notes/#configuring-ntp-with-netinfo)
*  [Ntp4 Versus Previous Versions](/documentation/4.1.0/notes/#ntp4-versus-previous-versions)
*  [Traffic Monitoring](/documentation/4.1.0/notes/#traffic-monitoring)
*  [Address-and-Mask Restrictions](/documentation/4.1.0/notes/#address-and-mask-restrictions)
*  [Authentication](/documentation/4.1.0/notes/#authentication)
*  [Query Programs](/documentation/4.1.0/notes/#query-programs)
*  [Run-Time Reconfiguration](/documentation/4.1.0/notes/#run-time-reconfiguration)
*  [Name Resolution](/documentation/4.1.0/notes/#name-resolution)
*  [Dealing with Frequency Tolerance Violations](/documentation/4.1.0/notes/#dealing-with-frequency-tolerance-violations)
*  [Tuning Your Subnet](/documentation/4.1.0/notes/#tuning-your-subnet)
*  [Provisions for Leap Seconds and Accuracy Metrics](/documentation/4.1.0/notes/#provisions-for-leap-seconds-and-accuracy-metrics)
*  [Clock Support Overview](/documentation/4.1.0/notes/#clock-support-overview)
*  [Towards the Ultimate Tick](/documentation/4.1.0/notes/#towards-the-ultimate-tick)
*  [Parting Shots](/documentation/4.1.0/notes/#parting-shots)
...
Additional information on the interpretation of these data with respect to various radio clock drivers is given in the [Reference Clock Drivers](/documentation/4.1.0/refclock/) document page and in the individual driver documents accessible via that page.
...
There are three ways to implement PPS support, depending on the radio clock model, platform model and serial line interface. These are described in detail in the application notes mentioned in the [The Network Time Protocol (NTP) Distribution](/documentation/4.1.0/) document page. Each of these requires circuitry to convert the TTL signal produced by most clocks to the EIA levels used by most serial interfaces. The [Gadget Box PPS Level Converter and CHU Modem](/documentation/4.1.0/gadget/) page describes a device designed to do this. Besides being useful for this purpose, this device includes an inexpensive modem designed for use with the Canadian CHU time/frequency radio station.
