...
An NTP packet consists of a set of fixed fields that may be followed by optional fields. Two types of optional fields are defined: extension fields (EFs) as defined in Section 7.5 of [RFC 5905](/reflib/rfc/rfc5905.txt), and legacy Message Authentication Codes (legacy MACs). 
...
Additional information about the content of a MAC is specified in [RFC 5906](/reflib/rfc/rfc5906.txt), but since that RFC is Informational an implementor that was not planning to provide Autokey would likely never read that document. The result of this would be interoperability problems, at least. To address this problem this proposal also copies and clarifies some of the content of RFC 5906, putting it into RFC 5905. Because there is a reasonable expectation that RFC 5906 will be deprecated, this document does not propose changes or updates to RFC 5906. 

NTP extension fields are defined in [RFC 5905](/reflib/rfc/rfc5905.txt) as a generic mechanism that allows the addition of future extensions and features without modifying the NTP header format (Section 16 of [RFC 5905](/reflib/rfc/rfc5905.txt)). 
...
This document better specifies and clarifies extension fields as well as the requirements and parsing of a legacy MAC, with changes to address errors found after the publication of [RFC 5905](/reflib/rfc/rfc5905.txt) with respect to extension fields. Specifically, this document updates Section 7.5 of [RFC 5905](/reflib/rfc/rfc5905.txt), clarifying the relationship between extension fields and MACs, and expressly defines the behavior of a host that receives an unknown extension field.
...
This section describes the crypto-NAK, which should be described in RFC 5905. A crypto-NAK is used by RFC 5905 as well. [This is additional evidence that even though RFC 5906 was Informational, some of its content is REQUIRED for proper behavior for RFC 5095.]
...
[The 'R' flag is currently used by Autokey [RFC 5906](/reflib/rfc/rfc5906.txt), and by the proposed I-DO [DRAFT-I-DO](/documentation/ietf/ntp-i-do/) extension field. This flag is used after the packet is accepted.] 
...
[The EF Code subtype is currently used by [Autokey RFC5906](/reflib/rfc/rfc5906.txt), by the proposed Extended Information [DRAFT-EXTENDED-INFORMATION](/documentation/ietf/ntp-extended-information-ef/), I-DO [DRAFT-I-DO](//documentation/ietf/ntp-extended-i-do/), and is expected to be used by the NTS Extension Field, at least.] 
...
Note well that to-date, there are only two defined Extension Field Types: Autokey, defined by [RFC 5906](/reflib/rfc/rfc5906.txt), and the Experimental UDP Checksum Complement in the Network Time Protocol, defined by [RFC 7821](https://www.rfc-editor.org/info/rfc7821). 
...
The second way to prevent ambiguous parsing is to use the LAST-EF [DRAFT-MAC-LAST-EF](/documentation/ietf/ntp-mac-last-ef/) extension field. 
