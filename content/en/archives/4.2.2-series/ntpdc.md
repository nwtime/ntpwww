...
These commands operate in the same way as the <tt>enable</tt> and <tt>disable</tt> configuration file commands of <tt>ntpd</tt>. See the [Miscellaneous Options](/archives/4.2.2-series/miscopt) page for further information.
