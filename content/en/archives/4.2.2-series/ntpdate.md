...
**Disclaimer:** The functionality of this program is now available in the <tt>ntpd</tt> program. See the `-q` command line option in the [<tt>ntpd</tt> - Network Time Protocol (NTP) daemon](/archives/4.2.2-series/ntpd) page. After a suitable period of mourning, the <tt>ntpdate</tt> program will be retired from this distribution.

* * *

#### Table of Contents

* [Synopsis](/archives/4.2.2-series/ntpdate/#synopsis)
* [Description](/archives/4.2.2-series/ntpdate/#description)
* [Command Line Options](/archives/4.2.2-series/ntpdate/#command-line-options)
* [Files](/archives/4.2.2-series/ntpdate/#files)
* [Bugs](/archives/4.2.2-series/ntpdate/#bugs)
