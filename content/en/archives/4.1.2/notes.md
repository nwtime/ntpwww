...
*  [Introduction](/archives/4.1.2/notes/#introduction)
*  [How NTP Works](/archives/4.1.2/notes/#how-ntp-works)
*  [Configuring Your Subnet](/archives/4.1.2/notes/#configuring-your-subnet)
*  [Configuring Your Server or Client](/archives/4.1.2/notes/#configuring-your-server-or-client)
*  [Configuring NTP with NetInfo](/archives/4.1.2/notes/#configuring-ntp-with-netinfo)
*  [Ntp4 Versus Previous Versions](/archives/4.1.2/notes/#ntp4-versus-previous-versions)
*  [Traffic Monitoring](/archives/4.1.2/notes/#traffic-monitoring)
*  [Address-and-Mask Restrictions](/archives/4.1.2/notes/#address-and-mask-restrictions)
*  [Authentication](/archives/4.1.2/notes/#authentication)
*  [Query Programs](/archives/4.1.2/notes/#query-programs)
*  [Run-Time Reconfiguration](/archives/4.1.2/notes/#run-time-reconfiguration)
*  [Name Resolution](/archives/4.1.2/notes/#name-resolution)
*  [Dealing with Frequency Tolerance Violations](/archives/4.1.2/notes/#dealing-with-frequency-tolerance-violations)
*  [Tuning Your Subnet](/archives/4.1.2/notes/#tuning-your-subnet)
*  [Provisions for Leap Seconds and Accuracy Metrics](/archives/4.1.2/notes/#provisions-for-leap-seconds-and-accuracy-metrics)
*  [Clock Support Overview](/archives/4.1.2/notes/#clock-support-overview)
*  [Towards the Ultimate Tick](/archives/4.1.2/notes/#towards-the-ultimate-tick)
*  [Parting Shots](/archives/4.1.2/notes/#parting-shots)
...
Additional information on the interpretation of these data with respect to various radio clock drivers is given in the [Reference Clock Drivers](/archives/4.1.2/refclock/) document page and in the individual driver documents accessible via that page.
...
There are three ways to implement PPS support, depending on the radio clock model, platform model and serial line interface. These are described in detail in the application notes mentioned in the [The Network Time Protocol (NTP) Distribution](/archives/4.1.2/) document page. Each of these requires circuitry to convert the TTL signal produced by most clocks to the EIA levels used by most serial interfaces. The [Gadget Box PPS Level Converter and CHU Modem](/archives/4.1.2/gadget/) page describes a device designed to do this. Besides being useful for this purpose, this device includes an inexpensive modem designed for use with the Canadian CHU time/frequency radio station.
