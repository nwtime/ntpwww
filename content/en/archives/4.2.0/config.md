...
*   [Basic Configuration Options - the <tt>configure</tt> utility](/archives/4.2.0/config/#basic-configuration-options---the-ttconfigurett-utility)
*   [Options](/archives/4.2.0/config/#options)
*   [Directory and File Names](/archives/4.2.0/config/#directory-and-file-names)
*   [Host Type](/archives/4.2.0/config/#host-type)
*   [Optional Packages](/archives/4.2.0/config/#optional-packages)
*   [Optional Features](/archives/4.2.0/config/#optional-features)
*   [Radio Clocks](/archives/4.2.0/config/#radio-clocks)
*   [PARSE Clocks](/archives/4.2.0/config/#parse-clocks)
