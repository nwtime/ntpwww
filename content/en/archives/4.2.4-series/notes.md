...
*  [Introduction](/archives/4.2.4-series/notes/#introduction)
*  [How NTP Works](/archives/4.2.4-series/notes/#how-ntp-works)
*  [Configuring Your Subnet](/archives/4.2.4-series/notes/#configuring-your-subnet)
*  [Configuring Your Server or Client](/archives/4.2.4-series/notes/#configuring-your-server-or-client)
*  [Configuring NTP with NetInfo](/archives/4.2.4-series/notes/#configuring-ntp-with-netinfo)
*  [Ntp4 Versus Previous Versions](/archives/4.2.4-series/notes/#ntp4-versus-previous-versions)
*  [Traffic Monitoring](/archives/4.2.4-series/notes/#traffic-monitoring)
*  [Address-and-Mask Restrictions](/archives/4.2.4-series/notes/#address-and-mask-restrictions)
*  [Authentication](/archives/4.2.4-series/notes/#authentication)
*  [Query Programs](/archives/4.2.4-series/notes/#query-programs)
*  [Run-Time Reconfiguration](/archives/4.2.4-series/notes/#run-time-reconfiguration)
*  [Name Resolution](/archives/4.2.4-series/notes/#name-resolution)
*  [Dealing with Frequency Tolerance Violations](/archives/4.2.4-series/notes/#dealing-with-frequency-tolerance-violations)
*  [Tuning Your Subnet](/archives/4.2.4-series/notes/#tuning-your-subnet)
*  [Provisions for Leap Seconds and Accuracy Metrics](/archives/4.2.4-series/notes/#provisions-for-leap-seconds-and-accuracy-metrics)
*  [Clock Support Overview](/archives/4.2.4-series/notes/#clock-support-overview)
*  [Towards the Ultimate Tick](/archives/4.2.4-series/notes/#towards-the-ultimate-tick)
*  [Parting Shots](/archives/4.2.4-series/notes/#parting-shots)
...
There are three ways to implement PPS support, depending on the radio clock model, platform model and serial line interface. These are described in detail in the application notes mentioned in the [The Network Time Protocol (NTP) Distribution](/archives/4.2.4-series/) document page. Each of these requires circuitry to convert the TTL signal produced by most clocks to the EIA levels used by most serial interfaces. The [Pulse-per-second (PPS) Signal Interfacing](/archives/4.2.4-series/pps/) page describes a device designed to do this. Besides being useful for this purpose, this device includes an inexpensive modem designed for use with the Canadian CHU time/frequency radio station.
