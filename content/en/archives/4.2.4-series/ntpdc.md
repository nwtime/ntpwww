...
<dt><tt>addpeer _peer_address_ [ _keyid_ ] [ _version_ ] [ <tt>minpoll# | prefer | iburst | burst | minpoll _N_ | <tt>maxpoll</tt> _N_ [ dynamic ] [...]</tt> ]</tt></dt>
...
<dt><tt>addserver _peer_address_ [ <tt>prefer | iburst | burst | minpoll _N_ | <tt>maxpoll</tt> _N_ | <tt>keyid</tt> _N_ | <tt>version</tt> _N_ [ dynamic } [...]</tt> ]</tt></dt>
...
These commands operate in the same way as the <tt>enable</tt> and <tt>disable</tt> configuration file commands of <tt>ntpd</tt>. See the [Miscellaneous Options](/archives/4.2.4-series/miscopt) page for further information.
