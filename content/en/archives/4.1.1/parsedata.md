...
* [Meinberg clocks](/archives/4.1.1/parsedata/#meinberg-clocks)
* [Raw DCF77 Data via serial line](/archives/4.1.1/parsedata/#raw-dcf77-data-via-serial-line)
* [DCF77 raw time code](/archives/4.1.1/parsedata/#dcf77-raw-time-code)
* [Schmid clock](/archives/4.1.1/parsedata/#schmid-clock)
* [Trimble SV6 ASCII time code (TAIP)](/archives/4.1.1/parsedata/#trimble-sv6-ascii-time-code-taip)
* [ELV DCF7000](/archives/4.1.1/parsedata/#elv-dcf7000)
* [HOPF 6021 und Kompatible](/archives/4.1.1/parsedata/#hopf-6021-und-kompatible)
* [Diem Computime Clock](/archives/4.1.1/parsedata/#diem-computime-clock)
* [WHARTON 400A Series Clock with a 404.2 Serial interface](/archives/4.1.1/parsedata/#wharton-400a-series-clock-with-a-4042-serial-interface)
