...
The filter is activated by the <code>tinker</code> command and <code>huffpuff</code> keyword, as described in the [Miscellaneous Options](/archives/4.1.1/miscopt) page.
...
Various internal <code>ntpd</code> variables can be displayed and configuration options altered while the <code>ntpd</code> is running using the <code>[ntpq](/archives/4.1.1/ntpq)</code> and [<code>ntpdc</code>](/archives/4.1.1/ntpdc) utility programs.
...
[Configuration Options](/archives/4.1.1/confopt)  
