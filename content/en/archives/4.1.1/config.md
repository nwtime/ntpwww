...
*   [Basic Configuration Options - the <tt>configure</tt> utility](/archives/4.1.1/config/#basic-configuration-options---the-ttconfigurett-utility)
*   [Options](/archives/4.1.1/config/#options)
*   [Directory and File Names](/archives/4.1.1/config/#directory-and-file-names)
*   [Host Type](/archives/4.1.1/config/#host-type)
*   [Optional Packages](/archives/4.1.1/config/#optional-packages)
*   [Optional Features](/archives/4.1.1/config/#optional-features)
*   [Radio Clocks](/archives/4.1.1/config/#radio-clocks)
*   [PARSE Clocks](/archives/4.1.1/config/#parse-clocks)
