...
5.2.2. [Alternatives](#522-alternatives)  
   5.2.2.1. [Should the Kernel Discipline be used?](#5221-should-the-kernel-discipline-be-used)  
5.2.3. [Monitoring](#523-monitoring)  
   5.2.3.1. [What are the individual monitoring values about?](#5231-what-are-the-individual-monitoring-values-about)  
5.2.4. [PPS Processing](#524-pps-processing)  
   5.2.4.1. [What is PPS Processing?](#5241-what-is-pps-processing)  
   5.2.4.2. [How is PPS Processing related to the Kernel Discipline?](#5242-how-is-pps-processing-related-to-the-kernel-discipline)  
   5.2.4.3. [What does hardpps() do?](#5243-what-does-hardpps-do)
