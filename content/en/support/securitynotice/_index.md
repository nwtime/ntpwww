      ...
      <div class="col">
        <div class="card mh-100">
          <div class="card-body">
            ...
            <p>When security patches are ready, they are first given to Premier and Partner Institutional members of the 
			<a href="https://www.nwtime.org/membership/benefits/">NTP Consortium at Network Time Foundation</a>, then access instructions are 
			provided to <a href="https://www.sei.cmu.edu/divisions/cert/">CERT</a>, and finally the public release is made on the embargo date.</p>
      ...
      <div class="col">
	    <div class="card mh-100">
          <div class="card-body">
            ...
            <p class="card-text">If you find a security vulnerability in the NTP codebase, please report it by <b>PGP-encrypted</b> <a href="mailto:security.ntp@lists.nwtime.org">email to the NTF Security Officer Team</a>. You can use our <a href="https://www.nwtime.org/about/documents/NTFSecurityOfficerPGPKey.txt">NTF Security Officer PGP Key</a>. Please refrain from discussing potential security issues in any mailing lists or public forums.</p>
